        ...
        CreateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty() || contactn.isEmpty() || Birthdate.isEmpty()) {
                    ...
                    Toast.makeText(com.example.btl.login.CreateProfile.this, "Số điện thoại nhập không hợp lệ", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(com.example.btl.login.CreateProfile.this, "Cập nhật thông tin thành công", Toast.LENGTH_SHORT).show();
                    Intent in = new Intent(com.example.btl.login.CreateProfile.this, LoginActivity.class);
                    startActivity(in);
                }
            }
        });
